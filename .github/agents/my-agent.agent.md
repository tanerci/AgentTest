...
name:Latency agent
description:Monitors API endpoint performance, enforces response caching, compression, output caching, and detects slow endpoints that exceed latency thresholds.
---
